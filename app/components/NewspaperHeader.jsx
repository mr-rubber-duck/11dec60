        ...
        <section id="hero-header" className="max-w-7xl mx-auto px-6 lg:px-8 pt-4">
            ...
            <div className="text-center my-4 pb-4" style={{ borderBottom: '1px solid #9B9B85' }}>
                ...
                <p className="font-playfair" style={{
                    ...
                    عندما اختار الجزائريون سلوك درب الحرية والطرْق على بابها، كانوا على يقين، <br /> كما قال أحمد شوقي بأنّ:
                </p>
                ...
                <p className=" p-4 text-base mt-1" style={{ color: '#ffffffff' }}>
                    "تُعدّ مظاهرات 11 ديسمبر 1960 المجيدة، محطة حاسمة وفارقة في تاريخ الكفاح الوطني، ومسمارًا أخيرًا في وضع حد لمشروع الاحتلال الفرنسي<br />
                    الذي جثم على أرضنا أكثر من قرن. لقد كانت هذه الانتفاضة الشعبية العارمة، التي عمت شوارع الجزائر العاصمة وكبرى المدن، <br>
                    </br>تعبيرًا لا لبس فيه عن الإرادة المطلقة للشعب الجزائري في افتكاك حريته واسترداد سيادته كاملة غير منقوصة.
                    <br /><br />
                    لقد أسقطت هذه المظاهرات، التي واجهت وحشية استعمارية مطولة، كل الأوهام التي كان يراهن عليها جنرالات فرنسا وعلى رأسهم ديغول؛ <br />حيث بددت محاولاته اليائسة لفرض حلول استعمارية جزئية، وأثبتت للعالم أن خيار الشعب الجزائري الوحيد هو الاستقلال التام والسيادة الوطنية.<br /> لم تكن هذه الأحداث مجرد 'تحول' بل كانت تتويجًا لتضحيات سنوات طويلة<br /
                    > وأعلنت بداية العد التنازلي لإجبار فرنسا على الاعتراف بحقيقة انتصار الثورة."
                </p>
            </div>
        </section>
    );
