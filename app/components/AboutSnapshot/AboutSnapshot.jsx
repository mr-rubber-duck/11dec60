        ...
        <section className={styles.section}>
            <div className={styles.container}>
                ...
                <div className={styles.aboutRow}>
                    ...
                    <div className={styles.textContent}>
                        <h2 className={styles.heading}> الشخصيات الفاعلة

                        </h2>
                        <div className={styles.newspaperDivider}></div>
                        <p>
                            1.  الطرف الجزائري
                            قيادات جبهة التحرير الوطني والحكومة المؤقتة (أحمد بن بلة، فرحات
                            عباس، وآخرون) الذين كانوا يقودون العمل السياسي والدبلوماسي للثورة.


                        </p>
                        <p>
                            2.  الطرف الفرنسي
                            – شارل ديغول: الرئيس الفرنسي وصاحب مشروع الحكم الذاتي الذي رفضه
                            الجزائريون.
                            – القوات الفرنسية: الوحدات العسكرية والشرطة التي قمعت المظاهرات
                            بعنف.
                        </p>
                    </div>
                </div>
                ...
                <div className={styles.aboutRowReverse}>
                    <div className={styles.textContent}>
                        ...
                        <p>
                            ...
                            مصادر أرشيفية مختلفة تشير إلى سقوط مئات الضحايا من المدنيين نتيجة الرصاص
                            والقمع. بعض التقارير الفرنسية تقدم أرقاماً أقل، بينما مصادر جزائرية
                            ودولية تقدّر العدد بأكثر.
                            <br /><br />

                            هذه المظاهرات أجبرت فرنسا على تغيير خطابها والجلوس إلى طاولة المفاوضات،
                            ما مهّد لاتفاقيات إيفيان بعد عامين فقط.
                        </p>
                    </div>
                    <div className={styles.imageWrapper}>
                        <Image
