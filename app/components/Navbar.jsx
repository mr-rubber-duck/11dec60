                ...
                <div style={{
                    ...
                    <div className="flex justify-between items-center" style={{ height: '4rem' }}>
                        ...
                        <div className="desktop-menu">
                            ...
                            <Link href="/docementry" className="nav-link">الوثائقي</Link>
                ...
                {isOpen && (
                    <div className="mobile-menu">
                        <div className="flex flex-col" style={{
                            ...
                            <Link href="/docementry" className="mobile-link">الوثائقي</Link>
                            <Link href="/gallery" className="mobile-link">المعرض</Link>

                            <Link href="/chat" className="mobile-link">الدردشة</Link>
